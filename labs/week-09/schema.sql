...
INSERT INTO users (name, department, email) VALUES
  ...
  ('วรรณิดา มุ่งมั่น',  'วิศวกรรมไฟฟ้า',     'wannida@rmutl.ac.th');

-- ④ ใส่ข้อมูลตั้งต้น — requests อย่างน้อย 5 รายการ
INSERT INTO requests (id, requester_id, request_type, location, details, priority, status) VALUES
  ...
  ('REQ-006', 2, 'แจ้งซ่อม',          'อาคารวิศวกรรมซอฟต์แวร์',  'ไฟห้องเรียน 204 ดับทั้งแถว ใช้งานไม่ได้',     'urgent', 'in-progress'),
  ('REQ-007', 5, 'ขอใช้อุปกรณ์',      'ห้องปฏิบัติการ 401',       'ขอยืมเครื่องมือวัดแรงดันไฟฟ้าสำหรับทดลอง',   'normal', 'pending'),
  ('REQ-008', 3, 'อื่น ๆ',            'อาคารวิศวกรรมไฟฟ้า',       'ขอติดป้ายแสดงขั้นตอนการใช้งานอุปกรณ์',       'normal', 'completed');
